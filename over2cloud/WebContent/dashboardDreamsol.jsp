...
<img src="images/footer_logo.png" width="50%" height="50%" align="top" style="margin-left: 264px;margin-top: 149px;">
         </div>
<div class="clear"></div>
<div class="container_block">
   ...
   <div class="footer"  style="height: 15px;">
	...
	<ul>
	<li><a href="reportABug.action"  class="booking">Report a Bug</a></li>
	<li><a href="viewNewsandalerts.action"  class="newsAlerts">News And Alerts</a></li>
	<li><a href="seekAssistence.action"  class="booking">Seek Assistance</a></li>
	</ul>
	</div>
	</div>
	</div>
...
<script>
	...
	$(".booking").colorbox({rel:'booking', transition:"elastic",width:"70%",height:"75%"});
	
	});

	$(document).ready(function(){
	//Examples of how to assign the ColorBox event to elements
	$(".newsAlerts").colorbox({rel:'booking', transition:"elastic",width:"50%",height:"50%"});
