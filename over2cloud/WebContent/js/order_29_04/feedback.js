$.subscribe('validateActionForPharma', function(event,data)
{
...
//	var a = parseInt(data)
	//alert(intvrl1);
	  intvrl1=setInterval("ORDERActivityRefresh()", (30*1000));
...
function onloadData()
{
	...
	if(chkFlag!='Pharmacy')
	{
		...
		({
		type : "post",
		url  : "view/Over2Cloud/CorporatePatientServices/Activity_Board/viewActivityBoardColumnCPS.action?heart="+chkFlag+"&priority="+prioFlag+"&minDateValue="+minDateValue+"&maxDateValue="+maxDateValue+"&feedStatus="+status+"&nursingUnit="+nUnit,
	...
	else
	{
		...
		var nUnit = $("#nursingUnit1_widget").val();
		var encounterId = $("#encounterId_widget").val();
  		$.ajax
		({
		type : "post",
		url  : "view/Over2Cloud/CorporatePatientServices/Pharmacy/beforeActivityBoardDataForPharmacy.action?priority="+prioFlag+"&minDateValue="+minDateValue+"&maxDateValue="+maxDateValue+"&feedStatus="+status+"&nursingUnit="+nUnit+"&uhid="+uhid+"&roomNo="+roomNo+"&encounterId="+encounterId,
		success : function(data)
		{
