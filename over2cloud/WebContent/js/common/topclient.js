...
//High Cost Med	  machineOrderMaste.xml
function high_cost_med1()
{
	  $("#data_part").html("<br><br><br><br><br><br><br><br><br><br><br><br><center><img src=images/ajax-loaderNew.gif></center>");
		$.ajax({
		    type : "post",
		    url : "view/Over2Cloud/CorporatePatientServices/Pharmacy/highCostMed.action",
		    success : function(data) 
		    {
				$("#"+"data_part").html(data);
		    },
...
function pharmacyDashboard(){
		...
		$.ajax({
		    type : "post",
		    url : "view/Over2Cloud/CorporatePatientServices/Pharmacy/beforeDashboardView.action",
...
//Long Time Patient Stay

function viewLongPatientStay(){

	
	$("#data_part").html("<br><br><br><br><br><br><br><br><br><br><br><br><center><img src=images/ajax-loaderNew.gif></center>");
	$.ajax({
	    type : "post",
	    url : "view/Over2Cloud/LongPatientStay/viewLongPatientStayHeader.action",
	    success : function(subdeptdata) {
     $("#"+"data_part").html(subdeptdata);
	},
	   error: function() {
...
//Patient Move Tracking

function viewPatientMoveTrack(){

	
	$("#data_part").html("<br><br><br><br><br><br><br><br><br><br><br><br><center><img src=images/ajax-loaderNew.gif></center>");
	$.ajax({
	    type : "post",
	    url : "view/Over2Cloud/PatientMovementTracking/viewPatientMovementTrackingHeader.action",
	    success : function(subdeptdata) {
     $("#"+"data_part").html(subdeptdata);
	},
	   error: function() {
...
//bed tracking by Aarif started at 03-08-2016

function beforeViewBedTracking(){
	
	$("#data_part").html("<br><br><br><br><br><br><br><br><br><br><br><br><center><img src=images/ajax-loaderNew.gif></center>");
	$.ajax({
	    type : "post",
	    url : "view/Over2Cloud/bedTransfer/beforeViewBedTrackingHeader.action",
	    success : function(subdeptdata) {
       $("#"+"data_part").html(subdeptdata);
	},
	   error: function() {
...
function bedTrackingEscalation()
{
	  
		$("#data_part").html("<br><br><br><br><br><br><br><br><br><br><br><br><center><img src=images/ajax-loaderNew.gif></center>");
		$.ajax({
		    type : "post",
		    url : "view/Over2Cloud/BedTransfer/bedEscalation/bedEscalationViewGrid.jsp",
		    success : function(data) 
		    {
				$("#"+"data_part").html(data);
		    },
...
function labOrderViewEscalation()
{
	  
		$("#data_part").html("<br><br><br><br><br><br><br><br><br><br><br><br><center><img src=images/ajax-loaderNew.gif></center>");
		$.ajax({
		    type : "post",
		    url : "view/Over2Cloud/LabOrder/labEscalationView/labEscalationViewGrid.jsp",
		    success : function(data) 
		    {
				$("#"+"data_part").html(data);
		    },
...
function beforeViewDischageAnnounced()
{
	$("#data_part").html("<br><br><br><br><br><br><br><br><br><br><br><br><center><img src=images/ajax-loaderNew.gif></center>");
	$.ajax({
	    type : "post",
	    url : "view/Over2Cloud/dischargeAnnounce/beforeViewDischargeAnnounceHeader.action",
	    success : function(data) 
	    {
			$("#"+"data_part").html(data);
	    },
