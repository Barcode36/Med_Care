...
function onloadData(data, prioFlag, minDateValue, maxDateValue,status,nUnit)
{
	...
	else
	{
		...
		({
		type : "post",
		url  : "view/Over2Cloud/CorporatePatientServices/Pharmacy/beforeActivityBoardDataForPharmacy.action?priority="+prioFlag+"&minDateValue="+minDateValue+"&maxDateValue="+maxDateValue+"&feedStatus="+status+"&nursingUnit="+nUnit,
		success : function(data)
		{
