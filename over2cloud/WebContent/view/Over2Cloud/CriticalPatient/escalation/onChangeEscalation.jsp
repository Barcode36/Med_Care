...
function changeinNextEsc1(data, div, sId, sName, nId, nName){
	...
	$.ajax({
		type :"post",
		url :"view/Over2Cloud/referral/escalation_config/nxxtLevelEscLst.action?l1="+l1+"&l2="+l2+"&l3="+l3+"&l4="+l4+"&div="+div+"&sId="+sId+"&sName="+sName+"&nId="+nId+"&nName="+nName+ "&subDept="+$("#esc_sub_dept").val(),
