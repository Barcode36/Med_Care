...
function editEscalation()
{
    ...
    else
    {
        ...
        (
            {
                type : "post",
                url : "/over2cloud/view/Over2Cloud/referral/escalation_config/getEscalation4Edit.action?id="+row+"&subDept="+subDept,
...
function addEscalation()
{
	...
	$.ajax({
	    type : "post",
	    url : "/over2cloud/view/Over2Cloud/referral/escalation_config/beforeConfigEscalation.action",
	    success : function(data) {
       		$("#data_part").html(data);
		},
	    error: function() {
...
<div class="list-icon">
	 <div class="head">
	 Cross  Referral Escalation</div><div class="head"><img alt="" src="images/forward.png" style="margin-top:50%; float: left;"></div>
...
<s:url id="viewModifyEsc" action="getEscalation4Edit" namespace="/view/Over2Cloud/referral/escalation_config"></s:url>
<s:url id="viewPart" action="getGridData" namespace="/view/Over2Cloud/referral/escalation_config">
</s:url>
