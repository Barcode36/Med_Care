...
<div class="list-icon">
	<div class="head">Manage Critical Escalationcc</div><img alt="" src="images/forward.png" style="margin-top:10px; float: left;"><div class="head"> Add</div>
...
<s:form id="formone" name="formone" action="addEscConfig" namespace="/view/Over2Cloud/CriticalMaster" theme="simple"  method="post" enctype="multipart/form-data" >
        			   ...
        			   <div class="leftColumn" >Priority:&nbsp;</div>
					        <div class="rightColumn">
				                  <s:select  id="priority"
				                              name="priority"
				                              list="{'Urgent','Routine','Stat','Critical'}"
				                              headerKey="Urgent"
