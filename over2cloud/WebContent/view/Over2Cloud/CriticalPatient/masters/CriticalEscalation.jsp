...
function editRow()
{
	...
	{	
		jQuery("#gridedittable").jqGrid('editGridRow', row ,{height:700, width:425,reloadAfterSubmit:false,closeAfterEdit:true,top:0,left:350,modal:true});
	}	
}
...
function addEsc()
{
	...
	$.ajax({
	    type : "post",
	 	   url : "view/Over2Cloud/CriticalMaster/beforeAddEsc.action",
	    	success : function(data) {
       		$("#data_part").html(data);
		},
	    error: function() {
...
<div class="list-icon">
	 <div class="head">
	 Manage Critical Escalation</div><div class="head"><img alt="" src="images/forward.png" style="margin-top:50%; float: left;"></div>
	...
	<table class="lvblayerTable secContentbb" border="0" cellpadding="0" cellspacing="0" width="100%">
		<tbody>
			<tr>
				  ...
				  <sj:a id="addButton"  button="true"  buttonIcon="ui-icon-plus" cssClass="button" onclick="addEsc();">Add</sj:a>
				  </td>
			</tr>
		</tbody>
	</table>
...
<s:url id="viewModifyEsc" action="editEscalationDept" namespace="/view/Over2Cloud/CriticalMaster"></s:url>
<s:url id="viewPart" action="getEscaltionGriddata" namespace="/view/Over2Cloud/CriticalMaster">
</s:url>
...
<sjg:grid 
		...
		name="firstEscFlag"
		index="firstEscFlag"
		title="First Escalation Time Flag"
		width="130"
		align="center"
		editable="true"
		edittype="select"
