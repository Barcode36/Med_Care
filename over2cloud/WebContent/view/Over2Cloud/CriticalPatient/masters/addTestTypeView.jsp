...
<s:url id="viewTestTypeMaster" action="viewTestTypeMaster" >
<s:param name="searchFields" value="%{searchFields}"></s:param>
<s:param name="SearchValue" value="%{SearchValue}"></s:param>
</s:url>
<s:url id="modifyTestType" action="modifyTestType" />
<center>
<sjg:grid 
		  id="addTypeTest"
          href="%{viewTestTypeMaster}"
          gridModel="viewTestTypeMaster"
          navigator="true"
          navigatorAdd="false"
          navigatorView="true"
