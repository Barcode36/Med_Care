...
<s:url id="blackListGrid" action="viewBlacKListDataGrid" escapeAmp="false" >
...
<s:url id="viewModifyblacklistGrid" action="modifyBlackList" >
...
<sjg:grid 
		...
		<s:elseif test="colomnName=='department'" >
        <sjg:gridColumn 
		name="%{colomnName}"
		index="%{colomnName}"
		title="%{headingName}"
