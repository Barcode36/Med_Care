...
<s:url id="viewMachineReasonMaster" action="viewMachineReasonMaster" >
<s:param name="searchFields" value="%{searchFields}"></s:param>
<s:param name="SearchValue" value="%{SearchValue}"></s:param>
</s:url>
<s:url id="modifyMachineResponse" action="modifyMachineResponse" />
<center>
<sjg:grid 
		  id="gridBasicDetails"
          href="%{viewMachineReasonMaster}"
          gridModel="machineResponseMasterData"
          navigator="true"
          navigatorAdd="false"
          navigatorView="true"
