...
function addEscDept()
{
	...
	$.ajax({
	    type : "post",
	    url : "/over2cloud/view/Over2Cloud/MachineOrder/BeforeConfigEsc.action",
	    success : function(data) {
       		$("#data_part").html(data);
		},
	    error: function() {
...
<div class="list-icon">
	 <div class="head">
	 Manage Order Escalation</div><div class="head"><img alt="" src="images/forward.png" style="margin-top:50%; float: left;"></div>
...
<s:url id="viewModifyEsc" action="editEscalationDept" namespace="/view/Over2Cloud/MachineOrder"></s:url>
<s:url id="viewPart" action="getGriddata" namespace="/view/Over2Cloud/MachineOrder">
</s:url>
