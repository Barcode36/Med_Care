...
getOnChangePrimaryData('flag','0');
</SCRIPT>
</head>
<body>
<div class="list-icon">
	 <div class="head">View Primary Contact </div><div class="head"><img alt="" src="images/forward.png" style="margin-top:50%; float: left;"></div><div class="head"><s:iterator value="totalCount">
		...
		<tbody>
			<tr>
						  ...
						  <s:select 
		                     ...
		                     <s:if test="%{hodStatus}">
						       ...
						       <s:select  
							      ...
							      theme                 =       "simple"
						      	 onchange			   =		"getDeptBySubGroup('contactSubType',this.value);getOnChangePrimaryData('groupId',this.value)"
						      	 >
						      	 </s:select>
						        ...
						        <s:select  
						      	 ...
						      	 >
						      	  ...
						      	  <s:select  
							          ...
							          cssStyle            =        "height: 26px;margin-top: -29px;margin-left:3px;width: 155px;"
							            theme               =       "simple"
							      	 	onchange			=		"getOnChangePrimaryData('flag',this.value) "
						      	 >
						      	 </s:select>
				  ...
				  <td class="alignright printTitle">
				      ...
				      <%if(userRights.contains("empl_ADD")) 
					{%>
