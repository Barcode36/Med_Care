...
<body>
	...
	<div class="middle-content">
		...
		<div class="list-icon">
			<div class="head">Standard Master Details</div>
			<div class="head">
			...
			<div class="container_block">
				<div style="float: left; padding: 20px 1%; width: 98%;">
					<s:form id="formone" name="formone"
						...
						action="addStandardMasterDetails" theme="css_xhtml" method="post"
		     	...
		     	<span id="complSpan" class="pIds" style="display: none; "><s:property value="%{key}"/>#<s:property value="%{value}"/>#<s:property value="%{colType}"/>#<s:property value="%{validationType}"/>,</span>
				    ...
				    <s:if test="%{mandatory}"><span class="needed"></span></s:if>
				      <s:if test="%{key == 'location_name'}">
				             ...
				             <s:elseif test="%{key == 'std_pack'}">
				         		<s:textfield  name="%{key}" id="%{key}"  maxlength="200" cssClass="textField" placeholder="Enter Data"/>
				         </s:elseif>
				         <s:else>
				         	<s:textfield  name="%{key}" id="%{key}"  maxlength="200" cssClass="textField" placeholder="Enter Data"/>
				         </s:else>
		 ...
		 <s:iterator value="packageFields" begin="1" end="2">
			...
			<div>	
					...
					<s:else>
	          			...
	          			<div class="user_form_button3" style="margin-left: -4px;"><sj:a value="-" onclick="deletediv('%{#levelIndx}')" cssStyle="margin-left: -26px;margin-top: 8px;" button="true">-</sj:a></div>
	       			</s:else>
       			</div>
				</div>
		 </s:iterator>
