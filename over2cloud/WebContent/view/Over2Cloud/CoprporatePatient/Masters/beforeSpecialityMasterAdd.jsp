...
<body>
	...
	<div class="middle-content">
		...
		<div class="list-icon">
			<div class="head">Speciality Master Details</div>
			<div class="head">
			...
			<div class="container_block">
				<div style="float: left; padding: 20px 1%; width: 98%;">
					<s:form id="formone" name="formone"
						...
						action="addSpecialityMasterDetails" theme="css_xhtml" method="post"
                        ...
                        <div class="clear"></div>
                         <div id="<s:property value="%{#typeIndx}"/>" style="display: none">
                            ...
                            <div class="newColumn">
                                ...
                                <div class="rightColumn1">
                                    <s:textfield name="spec_name"  id="spec_name%{#typeIndx}"  cssClass="textField" cssStyle="margin:0px 0px 10px 0px;" placeholder="Enter Data" />
                                    </div>
