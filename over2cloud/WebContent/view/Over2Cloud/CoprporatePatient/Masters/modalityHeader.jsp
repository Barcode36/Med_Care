...
modalityData();
	...
	function modalityData()
	{
		...
		$.ajax({
		    type : "post",
		    url : "view/Over2Cloud/CorporatePatientServices/cpservices/modalityView.action?wildSearch="+searchParameter+"&status="+$("#status").val(),
	...
	function addNewDept()
	{
		...
		$.ajax({
		    type : "post",
		    url : "view/Over2Cloud/CorporatePatientServices/cpservices/beforeAddModality.action",
		    success : function(subdeptdata) {
...
<div class="list-icon">
	 <div class="head">Services of Service</div><div class="head"><img alt="" src="images/forward.png" style="margin-top:50%; float: left;"></div><div class="head">View</div> 
</div> 
