...
function addNew(){
	...
	$.ajax({
	    type : "post",
	    url : "view/Over2Cloud/CorporatePatientServices/cpservices/beforeAddStandardMaster.action",
...
function getGridView()
{
	$.ajax({
 		type :"post",
 		url :"view/Over2Cloud/CorporatePatientServices/cpservices/viewStandardMasterDetails.action?status="+$("#flag").val()+"&serviceID="+$("#serviceID").val(),
...
<body>
<div class="list-icon">
	 <div class="head">Standard Master</div>
...
var selRowIds = jQuery('#gridStandardMaster').jqGrid('rowselect', 'selarrrow');
...
function editRow()
{
	...
	{
			jQuery("#gridStandardMaster").jqGrid('editGridRow', row ,{reloadAfterSubmit:false,closeAfterEdit:true,top:0,left:350,modal:true});
			reloadPage();
...
var status = jQuery("#gridStandardMaster").jqGrid('getCell',row,'status');
if(row==0)
{
...
{
$("#gridStandardMaster").jqGrid('delGridRow',row, {height:120,reloadAfterSubmit:true,top:0,left:350,modal:true});
reloadPage();
}
}
function searchRow()
{
	 $("#gridStandardMaster").jqGrid('searchGrid',row, {height:120,reloadAfterSubmit:true,top:0,left:350,modal:true});
}
 
function reloadPage()
{
var grid = $("#gridStandardMaster");
