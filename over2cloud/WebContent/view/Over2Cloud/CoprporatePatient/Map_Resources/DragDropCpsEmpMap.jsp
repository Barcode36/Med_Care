...
<script  src="js/jquery-ui.js"></script>
  ...
  //to get list of all department
    $.ajax({
    	    type : "post",
    	    url : "/over2cloud/view/Over2Cloud/CorporatePatientServices/cpservices/getDepartmentList.action?deptFlag=dept",
...
function maptomultiplewing(emp){
	...
	$("#maximizeDataDiv1").html("<br><br><br><br><br><center><img src=images/lightbox-ico-loading.gif></center>");
	 $.ajax({
	    type : "post",
	    url : "/over2cloud/view/Over2Cloud/CoprporatePatient/Map_Resources/multi_mapping_subdept.jsp",
	    success : function(data) 
	    {
...
var delay = (function(){
    ...
    $("#shiftViewDiv").hide();
  	$("#dpetEmpDiv").show();
  	  $.ajax({
      	    type : "post",
      	    url : "/over2cloud/view/Over2Cloud/CorporatePatientServices/cpservices/getEmployeeByDept.action?deptId="+selval,
      	    success : function(data) {
      	    	//alert(JSON.stringify(data));
      	    //	console.log(data);
                     	$('#catalog ul').empty();
	...
	$("#shiftTO2").hide();
  	 shift_employeeIdsForSaveAs=[];
      	$.ajax({
      	type:"post",
      	url: "/over2cloud/view/Over2Cloud/CorporatePatientServices/cpservices/getMappedEmployee.action?deptId="+$("#department").val()+"&shiftId="+shiftId+"&wingIds="+wing+"&viewFlag="+viewFlag,
      	async:false,
      	success: function(data){
      	//console.log(data);
 ...
 function adddivobj(divid){
	...
	$("#maxmizeViewDialog").dialog('open');
	 ...
	 $.ajax({
	  type : "post",
	   	    url : "/over2cloud/view/Over2Cloud/CorporatePatientServices/cpservices/deleteEmpByTrash.action",
	 ...
	 $.ajax({
	  type : "post",
	   	    url : "/over2cloud/view/Over2Cloud/CorporatePatientServices/cpservices/deleteEmpByTrash.action?viewFlag=ALL",
...
function save(){
	...
	//alert(shift_employeemapped_wing);
	 $.ajax({
	  type : "post",
  	    url : "/over2cloud/view/Over2Cloud/CorporatePatientServices/cpservices/addShiftWithSubdeptMapSave.action",
  	    data :  { shiftID: $("#shiftId1L").val(),shiftEmpMapSubdept:shift_employeemapped_wing.toString() },
  	    success : function(data) {
  	 $('#message').empty();
   	    	$('#message').append(data).css('color','black').css('display','block');
   	    $("#message").fadeIn('fast');
