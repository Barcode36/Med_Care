...
<div class="list-icon">
	<div class="head">Manage Escalation</div><img alt="" src="images/forward.png" style="margin-top:10px; float: left;"><div class="head"> Add</div><sj:a button="true" cssClass="button" buttonIcon="ui-icon-plus"  style="margin-top:4px; float: right;"  onclick="getOnlinePage()">Online Mode</sj:a> 
    			  ...
    			  <div class="newColumn">
                   ...
                   <div class="newColumn">
        			   <div class="leftColumn" >Time:&nbsp;</div>
					        <div class="rightColumn">
				                   <sj:datepicker placeholder="Enter L2 To L3 Time" cssStyle="margin:0px 0px 10px 0px"  cssClass="textField" timepickerOnly="true" timepicker="true" timepickerAmPm="false" id="toTime" name="l2Tol3" size="20"   readonly="true"   showOn="focus"/>
                           </div>
                   </div>
                   </div>
                    <div class="clear"> </div>   
