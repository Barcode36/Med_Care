...
<script  src="js/jquery-ui.js"></script>
  ...
  //to get list of all department
    $.ajax({
    	    type : "post",
    	    url : "/over2cloud/view/Over2Cloud/HelpDeskOver2Cloud/Escalation_Conf/depatmentsforlist.action?deptFlag=dept",
...
var delay = (function(){
	...
	$.ajax({
	      	    type : "post",
	      	    url : "/over2cloud/view/Over2Cloud/HelpDeskOver2Cloud/Escalation_Conf/BeforeConfigEscContact1.action?searchString="+search+"&deptId="+$("#department").val(),
	      	    success : function(data) {
	...
	$.ajax({
	      	    type : "post",
	      	    url : "/over2cloud/view/Over2Cloud/HelpDeskOver2Cloud/Escalation_Conf/getSkillDetails.action?trashEmpId="+emp.split("kk")[0],
	      	    success : function(data) {
  ...
  //	  alert(selval);
    ...
    function definecontent(selval){
  	  $.ajax({
    	    type : "post",
    	    url : "/over2cloud/view/Over2Cloud/HelpDeskOver2Cloud/Escalation_Conf/getfloorwingsdetail.action",
    	    success : function(data) {
    	    	$("#wings").empty();
  ...
  /*   //appending saved emp for floor
	...
	$("#shiftTO2").hide();
  	 shift_employeeIdsForSaveAs=[];
      	$.ajax({
      	type:"post",
      	url: "/over2cloud/view/Over2Cloud/HelpDeskOver2Cloud/Escalation_Conf/getmappedemployee.action?deptId="+$("#department").val()+"&shiftId="+shiftId+"&wingIds="+wing+"&viewFlag="+viewFlag,
      	async:false,
      	success: function(data){
      	//console.log(data);
 ...
 function adddivobj(divid){
	...
	$("#maxmizeViewDialog").dialog('open');
	 ...
	 $.ajax({
	  type : "post",
	   	    url : "/over2cloud/view/Over2Cloud/HelpDeskOver2Cloud/Escalation_Conf/deleteEmpByTrash.action?viewFlag=ALL",
	...
	// alert(realid);
	 ...
	 if(checkdel=='shift')
	 {
	 url1="/over2cloud/view/Over2Cloud/HelpDeskOver2Cloud/Escalation_Conf/deleteShift.action?viewFlag=empOnly";
	 }else if(checkdel=='all')
	 {
	 url1="/over2cloud/view/Over2Cloud/HelpDeskOver2Cloud/Escalation_Conf/deleteShift.action?"; 
	 }
...
function addShift()
{
	...
	$("#maximizeDataDiv").html("<br><br><br><br><br><center><img src=images/lightbox-ico-loading.gif></center>");
	 ...
	 $.ajax({
	  type : "post",
	  	    url : "/over2cloud/view/Over2Cloud/HelpDeskOver2Cloud/Escalation_Conf/saveEmpWing.action",
...
function fetchLiveShift(){
	$.ajax({
	  type : "post",
 	    url : "/over2cloud/view/Over2Cloud/HelpDeskOver2Cloud/Escalation_Conf/viewShift.action?deptId="+$("#department").val()+"&viewFlag=live",
 	    	success : function(data) {
 	    	if(data.length!=0){
 	    	$(".shiftTagL").css('display', 'inline-block');
 ...
 function saveShift(){
	...
	$.ajax({
	  type : "post",
	    url : "/over2cloud/view/Over2Cloud/HelpDeskOver2Cloud/Escalation_Conf/addShiftWithWingMap.action",
 ...
 function ViewShif(){
	...
	$.ajax({
	  type : "post",
 	    url : "/over2cloud/view/Over2Cloud/HelpDeskOver2Cloud/Escalation_Conf/viewShift.action?deptId="+$("#department").val(),
 	    	success : function(data) {
 	    	//console.log(data);
 	    	  	//$("#catalog ul").empty();
 	    	  	var temp='';
...
function editShiftTime(){
	$("#shiftViewDiv").hide();
	 $.ajax({
	  type : "post",
	  	    url : "/over2cloud/view/Over2Cloud/HelpDeskOver2Cloud/Escalation_Conf/editShiftTime.action",
...
function save(){
	...
	//alert(shift_employeemapped_wing);
	 $.ajax({
	  type : "post",
  	    url : "/over2cloud/view/Over2Cloud/HelpDeskOver2Cloud/Escalation_Conf/addShiftWithWingMapSave.action",
