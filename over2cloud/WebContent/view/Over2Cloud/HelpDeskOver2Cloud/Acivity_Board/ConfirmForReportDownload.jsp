...
<s:form action="feedbackDownloadAction" id="download" theme="css_xhtml">
	 
	<s:hidden name="tableAlis" value="%{tableAlis}" />
	<s:hidden name="fromDepart" value="%{fromDepart}" />
	<s:hidden name="feedStatus" value="%{feedStatus}" />
	<s:hidden name="minDateValue" value="%{minDateValue}" />
	<s:hidden name="maxDateValue" value="%{maxDateValue}" />
	<s:hidden name="taskType" value="%{taskType}" />
	<s:hidden name="lodgeMode" value="%{lodgeMode}" />
	<s:hidden name="closeMode" value="%{closeMode}" />
	<s:hidden name="escLevel" value="%{escLevel}" />
	<s:hidden name="escTAT" value="%{escTAT}" />
	<s:hidden name="sel_id" value="%{sel_id}"/>
