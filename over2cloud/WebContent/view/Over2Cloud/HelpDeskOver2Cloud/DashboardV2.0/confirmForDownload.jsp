...
<s:form action="feedbackDownloadAction" id="download" theme="css_xhtml" namespace="/view/Over2Cloud/HelpDeskOver2Cloud/Dashboard_Pages" >
...
<s:hidden name="dept_subdeptid" value="%{d_subdept_id}"></s:hidden>
<s:hidden name="dataFlag"     value="%{dataFlag}"></s:hidden>
<s:hidden name="level"     value="%{level}"></s:hidden>
