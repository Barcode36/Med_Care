 ...
 */
		  ...
		  function downloadFeedStatus()
		  {
		 	...
		 	var status=$("#feedStatus").val();
		  	...
		  	$.ajax({
		  	    type : "post",
		  	    url : "view/Over2Cloud/HelpDeskOver2Cloud/Dashboard_Pages/feedbackDownload.action?feedStatus="+status+"&dashFor="+$("#dashFor").val()+"&d_subdept_id="+$("#d_subdept_id").val()+"&dataFlag="+$("#dataFlag").val()+"&level="+$("#level").val()+"&fromDate="+$('#fromDate').val()+"&toDate="+$('#toDate').val(),
...
<s:url id="href_URLDashboardmgt" action="dashFeedbackDetail" escapeAmp="false" namespace="/view/Over2Cloud/HelpDeskOver2Cloud/Dashboard_Pages_Mgt">
