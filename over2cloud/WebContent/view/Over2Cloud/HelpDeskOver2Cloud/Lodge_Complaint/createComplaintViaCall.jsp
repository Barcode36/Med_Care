        ...
        <s:form id="formtask" name="formtask" action="/view/Over2Cloud/HelpDeskOver2Cloud/Lodge_Complaint/confirmEmployee4Ticket.jsp" theme="css_xhtml"  method="post" enctype="multipart/form-data" >
             ...
             <div class="newColumn">
              ...
              <div id="ccPersonDiv">
	              <div class="newColumn">
	                              ...
	                              list="{'No Data'}"
	                              headerKey="-1"
	                              headerValue="Select CC Contact Person" 
	                              cssStyle="width:28%"
	                              multiple="true"
	                              >
	                  				</s:select>
             ...
             <s:iterator value="feedbackCategoryColumns">
              ...
              <div class="newColumn">
                ...
                <div class="newColumn">
								...
								<div class="rightColumn1">
	                            <s:if test="%{mandatory}"><span class="needed"></span></s:if>
                 			   <s:textfield name="%{key}" id="feed_brief"  maxlength="500" placeholder="Enter Data" cssStyle="margin:0px 0px 10px 0px"  cssClass="textField"/>
               </div>
               </div>   				
               </s:if>
              ...
              <s:iterator value="feedbackSubCategoryTimeColumns" status="counter">
                ...
                <div class="newColumn">
								...
								<div class="rightColumn1">
	                            <s:if test="%{mandatory}"><span class="needed"></span></s:if>
                 			   <s:textfield name="%{key}" id="%{key}" readonly="true" maxlength="500" placeholder="Enter Data" cssStyle="margin:0px 0px 10px 0px"  cssClass="textField"/>
               </div>
               </div>   				
               </s:if>
          ...
          <%--      <div class="newColumn">
	         ...
	         <sj:submit 
	                        ...
	                        />
		              <sj:a cssStyle="margin-left: 209px;margin-top: -44px;" button="true" href="#" onclick="resetForm('formtask');">Reset</sj:a>
	        		  <sj:a cssStyle="margin-left: 10px;margin-top: -44px;" button="true" href="#" onclick="viewComplaintActivityBoard();">Back</sj:a>
