...
<s:url id="subDept_URL" action="viewFeedSubDept" escapeAmp="false">
<s:param name="dataFor" value="%{dataFor}"/>
</s:url>
<s:if test="%{dataFor=='HDM'}">
<s:url id="feedType_URL" action="viewFeedType4HDM" />
</s:if>
          ...
          <sjg:grid 
                ...
                <sjg:grid 
                    			...
                    			>
          						...
          						<sjg:grid 
		            							id="gridfeedsubcategory"
         										...
         										gridModel="feedSubCategoryData"
          		    							...
          		    							navigatorEditOptions="{top:-100,width:400,closeAfterEdit:true,reloadAfterSubmit:false}"
                    							...
                    							>
                                                 <sjg:gridColumn 
		      					    							...
		      					    							hidden="false"
		 														/>
		 										<s:iterator value="viewPageColumns" begin="6" id="feedSubCategoryColumnNames" >  
		 										<sjg:gridColumn 
		      													name="%{colomnName}"
		      													index="%{colomnName}"
		      													title="%{headingName}"
                                                ...
                                                <sjg:gridColumn 
		      					    							...
		      					    							hidden="false"
		 														/>
		 							   <s:iterator value="viewPageColumns" begin="4" end="5" id="feedCategoryColumnNames" >  
		 								<sjg:gridColumn 
		      												name="%{colomnName}"
		      												index="%{colomnName}"
		      												title="%{headingName}"
		 						 ...
		 						 <s:iterator value="viewPageColumns" begin="2" end="3" id="feedTypeColumnNames" >  
		 						  <sjg:gridColumn 
		      										 name="%{colomnName}"
		      										 index="%{colomnName}"
		      										 title="%{headingName}"
