              ...
              <table width="100%" border="1">
			    ...
			    <td align="left" ><strong>Admission Date:</strong></td>
					<td align="left" ><s:property value="%{add_date_time}"/></td>
			         <td align="left" ><strong>Practitioner Name:</strong></td>
					<td align="left" ><s:property value="%{PRACTITIONER_NAME}"/></td>
					  
			   </tr>
			   <tr  bgcolor="lightgrey" style="height: 25px">
	    			
					 <td align="left" ><strong>Event Status:</strong></td>
					 <td align="left" ><s:property value="#parameters.event_status"/></td>
					  <td align="left" ><strong>MT Level:</strong></td>
					 <td align="left" ><s:property value="#parameters.MT_LEVEL"/></td>
					  <td align="left" ><strong>BL Level:</strong></td>
					 <td align="left" ><s:property value="#parameters.MT_LEVEL"/></td>
...
<s:set var="section1" value="%{id}" />
  <div style="overflow-y:auto;border-radius:6px; height:auto; width:49%; float:left;border: 1px solid #e4e4e5; border-right: 1px solid rgba(176, 165, 165, 0.54);">
<table class="CSSTableGenerator"> 
		 	<tr>
		     	<td colspan="6"><b>History of Ticket: <s:property value="%{mt_ticket_no}"/></b></td>
	 		</tr>
	 	<tr>
		 		 <td style="background-color: lavender;color: firebrick;"><b>Status</b></td>
				 <td style="background-color: lavender;color: firebrick;"><b>Action At</b></td>
				 <td style="background-color: lavender;color: firebrick;"><b>Action By</b></td>
			   	 <td style="background-color: lavender;color: firebrick;"><b>Level</b></td>
			   	 <td style="background-color: lavender;color: firebrick;"><b>Allot To</b></td>
			   	 	 <td style="background-color: lavender;color: firebrick;"><b>Time Lapse</b></td>
  				 
  				 
	 	</tr>
		<s:iterator id="rsCompl"  status="status" value="%{history_list_mt}" >
			<s:set var="section2" value="#rsCompl.id" /><!--
					...
					<s:set var="section1" value="#rsCompl.id" />
			 	 	...
			 	 	--><tr>
				 	 	...
				 	 	<td><b><s:property value="#rsCompl.action_at"/></b></td> 
				 	 	<td><b><s:property value="#rsCompl.action_by"/></b></td> 
				 	   	<td><b><s:property value="#rsCompl.level"/></b></td>
				 	   	<td><b><s:property value="#rsCompl.allot_to"/></b></td>
             ...
             <div id="posts" style="overflow-x:auto; overflow-y:auto; border-radius:6px; height:auto; width:49%; float:right;border: 1px solid #e4e4e5; border-right: 1px solid rgba(176, 165, 165, 0.54);">
            
            <table class="CSSTableGenerator"> 
		 	<tr>
		     	<td colspan="6"><b>History of Ticket: <s:property value="%{bl_ticket_no}"/></b></td>
	 		</tr>
	 	<tr>
		 		 <td style="background-color: lavender;color: firebrick;"><b>Status</b></td>
				 <td style="background-color: lavender;color: firebrick;"><b>Action At</b></td>
		...
		<s:iterator id="rsCompl"  status="status" value="%{history_list_bl}" >
			<s:set var="section2" value="#rsCompl.id" />
...
<br>
<s:if test="%{rejectedCount.size>0}">

<table class="CSSTableGenerator"> 
		 	<tr>
		     	<td colspan="5"><b>Rejected Request</b></td>
	 		</tr>
	 	<tr>
		 		 <td style="background-color: lavender;color: firebrick;"><b>Current Bed</b></td>
				 <td style="background-color: lavender;color: firebrick;"><b>Status</b></td>
				 <td style="background-color: lavender;color: firebrick;"><b>Cancel By</b></td>
			   	 <td style="background-color: lavender;color: firebrick;"><b>Action At</b></td>
			   	 <td style="background-color: lavender;color: firebrick;"><b>Comment</b></td>
  				 
  				 
	 	</tr>
		<s:iterator id="rsCompl"  status="status" value="%{rejectedCount}" >
			
				
			 	 	<tr>
			 	 		<td><b><s:property value="#rsCompl.current_bed"/></b></td> 
				 	 	<td><b><s:property value="#rsCompl.status"/></b></td> 
				 	 	<td><b><s:property value="#rsCompl.cancel_by"/></b></td> 
