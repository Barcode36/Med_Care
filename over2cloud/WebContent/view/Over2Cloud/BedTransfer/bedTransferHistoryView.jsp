       ...
       <div class="border" style="height: 50%" id="1">
              ...
              <table width="100%" border="1">
			    ...
			    <tr  bgcolor="white" style="height: 25px">
					 ...
					 <td align="left" ><strong>Transfer To Bed:</strong></td>
			...
			<s:set var="section2" value="#rsCompl.id" />
					...
					<s:set var="section1" value="#rsCompl.id" />
			 	 	...
			 	 	<tr>
				 	 	...
				 	 	<td><b><a href="#" onclick="fetchLevelDetail('<s:property value="#rsCompl.status"/>','<s:property value="#rsCompl.level"/>','<s:property value="#rsCompl.history_id"/>');"><b><font color="blue"><s:property value="#rsCompl.level"/></font></b></a></b></td> 
