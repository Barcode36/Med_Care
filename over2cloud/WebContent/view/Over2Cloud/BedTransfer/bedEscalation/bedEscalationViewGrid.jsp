...
function editEscalation()
{
    ...
    else
    {
        ...
        (
            {
                type : "post",
                url : "view/Over2Cloud/bedTransfer/getEscalation4Edit.action?id="+row+"&subDept="+subDept,
...
function addEscalation()
{
	...
	$.ajax({
	    type : "post",
	    url : "view/Over2Cloud/bedTransfer/beforeConfigEscalation.action",
	    success : function(data) {
       		$("#data_part").html(data);
		},
	    error: function() {
...
<div class="list-icon">
	 <div class="head">
	 Bed Tracking Escalation</div><div class="head"><img alt="" src="images/forward.png" style="margin-top:50%; float: left;"></div>
...
<s:url id="viewPart" action="getEscalationDataOnGrid" namespace="/view/Over2Cloud/bedTransfer">
</s:url>
