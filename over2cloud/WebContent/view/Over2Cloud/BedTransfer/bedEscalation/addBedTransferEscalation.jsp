...
<script type="text/javascript">
	...
	function changeinNextEsc(data, div, sId, sName, nId, nName)
	{
		...
		{
			type : "post",
			url : "view/Over2Cloud/bedTransfer/nextEscMap4EmpL2.action?l1=" + l1 + "&l2=" + l2 + "&l3=" + l3 + "&l4=" + l4 + "&div=" + div + "&sId=" + sId + "&sName=" + sName + "&nId=" + nId + "&nName=" + nName+ "&subDept="+$("#esc_sub_dept").val(),
			success : function(data)
			{
				$('#' + div).html(data);
			},
	...
	<div class="border">
		<div class="container_block">
			<div style="float: left; padding: 10px 1%; width: 98%;">
				...
				<br>
				<s:form id="formone" name="formone" namespace="/view/Over2Cloud/bedTransfer" action="addEscalation" theme="css_xhtml" method="post" enctype="multipart/form-data">
					<div class="menubox">
						...
						<div class="newColumn">
							...
							<div class="rightColumn1">
								...
								--><s:select id="bed_transfer_status" name="bed_transfer_status" headerKey="-1"
									headerValue="Select Status" list="%{serviceDeptMap}"
...
<div class="clear"/>
					...
					<div class="buttonStyle"
						...
						<sj:a name="Cancel" href="#" cssClass="submit"
							...
							onclick="bedTrackingEscalation()" cssStyle="margin-top: -43px;">
					  	Back
					</sj:a>
					</div>
