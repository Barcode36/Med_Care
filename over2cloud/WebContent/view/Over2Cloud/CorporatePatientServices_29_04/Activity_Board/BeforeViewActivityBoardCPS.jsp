...
function takeActionForPharmacy(cellvalue, options, rowObject) 
{
		...
		if(rowObject.status=='Close' || rowObject.status=='Close-P')
		{
...
function onloadDataPharmacy(flag)
{
	...
	({
		type : "post",
		url  : "view/Over2Cloud/CorporatePatientServices/Pharmacy/beforeActivityBoardDataForPharmacy.action?nursingUnit="+nursingUnit+"&priority="+priority+"&minDateValue="+minDateValue+"&maxDateValue="+maxDateValue+"&feedStatus="+status+"&uhid="+uhid+"&roomNo="+roomNo+"&encounterId="+encounterId,
		async:false,
		success : function(data)
		{
...
<div id="PharmacySearchCriteriaDiv" style="display: none">
		<div id="viewGridTable"
			...
			<div style="" class="listviewButtonLayer" id="listviewButtonLayerDiv">
						...
						<tbody>
							<tr>
								<td>
										...
										list="#{'Ordered':'Ordered','Dispatch':'Dispatch','Dispatch-P':'Partial Dispatch','Dispatch Error':'Dispatch Error','Close':'Close','Close-P':'Partial Close','Parked':'Parked'}"
			 							theme="simple" cssClass="button" headerKey="-1"
										headerValue="Status"
										cssStyle="height: 28px;margin-top: 3px;margin-left: -2px;width: 95px;"
										onchange="dateClick('')">
			 					 ...
			 					 <!--
									...
									<sj:a  button="true" cssClass="button" tabindex="-1" cssStyle="float:right; margin-right: 2px;float: right;margin-right: 180px;margin-top: -30px;height:26px; width:30px;"  buttonIcon="ui-icon-arrowstop-1-s" onClick="downloadFeedStatus();" ></sj:a>
										
										
										<a href="#"
										style="height: 26px; width: 32px; "> <img
										src="images/SMSGreen12.png" width="20px" height="20px"
										style="  float:right; margin-right: 2px;float: right;margin-right: 101px;margin-top: -30px;"
										title="ALL" onclick="priorityClick('All');"></a> 
						 				 
										 <a
										href="#" style="height: 26px; width: 32px;"> <img
										src="images/SMSWhite12.png" width="20px" height="20px"
										style="  margin-left: 2px; float:right; float: right;margin-right: 67px;margin-top: -30px;"
										title="Routine" onclick="priorityClick('Routine');"></a>
										
										 <a
										href="#" style="height: 26px; width: 32px; "> <img
										src="images/SMSred12.png" width="20px" height="20px"
										style="  margin-left: 2px; float:right ;float: right;margin-right: 33px;margin-top: -30px;"
				...
				<div id="viewDataDivForPharmacy" onmouseover="StopRefresh()" onmouseout="StartRefresh()"
					style="overflow: scroll; max-height: 575px;" align="center">
