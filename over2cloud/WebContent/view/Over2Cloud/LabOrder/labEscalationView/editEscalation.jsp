...
<s:form id="EditEscalation" name="EditEscalation" action="EditEscalationAction" namespace="/view/Over2Cloud/labOrder" theme="simple"  method="post" enctype="multipart/form-data" >
     ...
     <div class="clear"></div>
	     ...
	     <sj:submit 
     		  	  ...
     		  	  <sj:a name="Cancel" href="#" cssClass="submit"
							...
							onclick="labOrderViewEscalation()" >
					  	Back
					</sj:a>
