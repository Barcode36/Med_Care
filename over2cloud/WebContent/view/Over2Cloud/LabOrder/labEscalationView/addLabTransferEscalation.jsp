...
<script type="text/javascript">
	...
	function changeinNextEsc(data, div, sId, sName, nId, nName)
	{
		...
		{
			type : "post",
			url : "view/Over2Cloud/labOrder/nextEscMap4EmpL2.action?l1=" + l1 + "&l2=" + l2 + "&l3=" + l3 + "&l4=" + l4 + "&div=" + div + "&sId=" + sId + "&sName=" + sName + "&nId=" + nId + "&nName=" + nName+ "&subDept="+$("#esc_sub_dept").val(),
			success : function(data)
			{
				$('#' + div).html(data);
			},
...
<body>
	...
	<div class="list-icon">
		...
		<div class="head">Lab Order Escalation</div>
		<div class="head">
	...
	<div class="border">
		<div class="container_block">
			<div style="float: left; padding: 10px 1%; width: 98%;">
				...
				<br>
				<s:form id="formone" name="formone" namespace="/view/Over2Cloud/labOrder" action="addEscalation" theme="css_xhtml" method="post" enctype="multipart/form-data">
					<div class="menubox">
					...
					<div class="newColumn">
							<div class="leftColumn1">Lab Name:</div>
							<div class="rightColumn1">
								<s:select id="lab_name" name="lab_name"  list="%{labMap}"
									cssClass="select" cssStyle="width:82%" headerKey="-1"
									headerValue="Select Lab Name" >
								</s:select>
							</div>
						</div>    
						...
						<div class="newColumn">
							...
							<div class="rightColumn1">
								<!--<span class="needed"></span>
								--><s:select id="order_status" name="order_status" headerKey="-1"
									headerValue="Select Status" list="%{statusMap}"
									cssClass="select" cssStyle="width:82%" onchange="changeinNextEsc('', 'l2esc' ,'empL2', 'l2', 'empL2', 'l3');">
								</s:select>
							</div>
						</div>
...
<div class="clear"/>
					...
					<div class="buttonStyle"
						...
						<sj:a name="Cancel" href="#" cssClass="submit"
							...
							onclick="labOrderViewEscalation()" cssStyle="margin-top: -43px;">
					  	Back
					</sj:a>
					</div>
