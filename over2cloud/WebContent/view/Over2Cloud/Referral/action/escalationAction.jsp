...
<div style="float: left; padding: 5px 0%; width: 100%;">
	...
	<div class="border">
		...
		<s:form id="formone1" name="formone1"
			namespace="/view/Over2Cloud/Referral" action="esacateActionOnReferral"
			...
			<s:hidden name="ref_to" id="ref_to" value="%{ref_to}"></s:hidden>
			<s:hidden name="refToSpec" id="refToSpec" value="%{refToSpec}"></s:hidden>
			<s:hidden name="bed" id="bed" value="%{bed}"></s:hidden>
			<s:hidden name="priority" id="priority" value="%{priority}"></s:hidden>
			...
			<table cellpadding="10px" rules="rows" width="99%" align="center">
				...
				<tr style="margin-top: 10px;display: none;" id="mobId" >
					...
					<td class="tdAlign"><span class="needed"></span><s:textfield id="escalate_to_mob" name="escalate_to_mob" cssClass="textField" theme="simple" placeHolder="Enter Mobile No"/></td>
				</tr>
			</table>	
			<center>
