...
<s:form action="excelDownload" id="download" theme="css_xhtml">
	...
	<s:hidden name="priority" value="%{priority}" />
	...
	<s:hidden name="nursingUnit" value="%{nursingUnit}" />
	<s:hidden name="uhid" value="%{uhid}" />
	<s:hidden name="patientName" value="%{patientName}" />
	<s:hidden name="encounterId" value="%{encounterId}" />
    <s:hidden name="roomNo" value="%{roomNo}"/>
