...
function highCostMedAdd()
{

	$("#data_part").html("<br><br><br><br><br><br><br><br><br><br><br><br><center><img src=images/ajax-loaderNew.gif></center>");
	$.ajax({
	    type : "post",
	    //url : "view/Over2Cloud/Text2Mail/beforemainKeywords.action", beforeAddHighCostMed
	    url : "view/Over2Cloud/MachineOrder/beforecreateAdd.action",
...
function editRow()
{
	...
	{
		jQuery("#gridBasicDetails").jqGrid('editGridRow', row ,{height:230, width:425,reloadAfterSubmit:true,closeAfterEdit:true,top:0,left:350,modal:true , afterSubmit: function () {
...
function deleteRow()
{
	...
	{
		$("#gridBasicDetails").jqGrid('delGridRow',row, {height:120, width:425,reloadAfterSubmit:true,closeAfterEdit:false,top:0,left:350,modal:true,caption:'Inactive',msg: "Inactive selected record(s)?",bSubmit: "Inactive" , afterSubmit: function () {
			getOnChangeMachineData('Active');
	    }});
...
function getOnChangeMachineData(searchFields)
{
	$.ajax({
	    type : "post",
	    //url : "/over2cloud/view/Over2Cloud/commonModules/makeHistory.action",
	    url : "view/Over2Cloud/MachineOrder/beforeMaterReasonGrid.action?searchFields="+searchFields,
...
<div class="list-icon">
 <div class="head">View High Cost Medicine Code </div><div class="head"><img alt="" src="images/forward.png" style="margin-top:50%; float: left;"></div><div class="head"><s:iterator value="totalCount">
		...
		<tbody>
			...
			<s:select  
				  ...
				  <td class="alignright printTitle">
				    ...
				    <sj:a button="true" cssClass="button" cssStyle="height:25px;"  title="Add"  buttonIcon="ui-icon-plus" onclick="highCostMedAdd();">Add</sj:a> 
