...
<s:hidden name="toDate"       value="%{toDate}"></s:hidden>
 <s:hidden name="machineId" value="%{machineId}"></s:hidden>
 ...
 <s:hidden name="dashFor" value="%{dashFor}"></s:hidden>
  <s:hidden name="location" value="%{location}"></s:hidden>
   <s:hidden name="feedId" value="%{feedId}"></s:hidden>
   <s:hidden name="time" value="%{time}"></s:hidden>
   <s:hidden name="nursingId" value="%{nursingId}"></s:hidden>
 <s:hidden name="escFlag" value="%{escFlag}"></s:hidden>
 
<s:url id="viewBoardData" action="dashFeedbackDetail" escapeAmp="false" namespace="/view/Over2Cloud/CorporatePatientServices/Dashboard_Pages">
...
<s:param name="toDate"       value="%{toDate}"></s:param>
 <s:param name="machineId" value="%{machineId}"></s:param>
<s:param name="dataFlag"       value="%{dataFlag}"></s:param>
 ...
 <s:param name="feedId" value="%{feedId}"></s:param>
<s:param name="time" value="%{time}"></s:param>
<s:param name="nursingId" value="%{nursingId}"></s:param>
 <s:param name="escFlag" value="%{escFlag}"></s:param>
