...
<div class="clear"></div>
 ...
 <div class="head">Bed Transfer</div><div class="head"><img alt="" src="images/forward.png" style="margin-top:50%; float: left;"></div><div class="head">
		...
		<tbody>
			<tr>
				  ...
				  <td>
					 ...
					 <td class="pL10">
					 <td >
				    <sj:datepicker cssStyle="height: 20px; width: 100px;float:left;" tabindex="-1"   cssClass="button"  id="fromDate" name="fromDate" size="20" maxDate="0"   readonly="true" onchange="onloadDataGridView();"  yearRange="2013:2050" showOn="focus" displayFormat="dd-mm-yy" placeholder="From Date"/>
			
			         
				</td>
				
				 <td >
				    <sj:datepicker cssStyle="height: 20px; width: 100px;float:left;" tabindex="-2"   cssClass="button"  id="toDate" name="toDate" size="20" maxDate="0"   readonly="true" onchange="onloadDataGridView();"  yearRange="2013:2050" showOn="focus" displayFormat="dd-mm-yy" placeholder="From Date"/>
