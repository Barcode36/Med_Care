...
<s:hidden name="subCategory_extra" id="test"></s:hidden>
			...
			<div class="rightColumn">
				<span class="needed" style="margin-top:10%;" ></span>
					...
					name="location"
				 	...
				 	selectBox="true"
					selectBoxIcon="true"
					 onSelectTopics="changeFlag,getSubFloorAndAllotTODetail,roomTicketDetail"
    ...
    <div class="clear"></div>
	 ...
	 <div class="fields" align="center">
			    ...
			    <center>
			         <sj:dialog id="confirmEscalationDialog" autoOpen="false" onCloseTopics="changeGrid" closeOnEscape="true" modal="true" title="Success Message" width="700" height="200" showEffect="slide" hideEffect="explode" position="['center','center']"></sj:dialog>
