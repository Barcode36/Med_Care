...
<div class="list-icon">
	 <div class="head">
	 Branch</div><div class="head"><img alt="" src="images/forward.png" style="margin-top:50%; float: left;"></div>
		...
		<tbody>
			<tr>
				  ...
				  <td class="alignright printTitle">
				    ...
				    <sj:a id="addButton1"  button="true"  buttonIcon="ui-icon-plus" cssClass="button" onclick="addNewCountry();">Country</sj:a>
				    <sj:a id="addButton2"  button="true"  buttonIcon="ui-icon-plus" cssClass="button" onclick="addHeadOffice();">Head</sj:a>
							<sj:a id="addButton3"  button="true"  buttonIcon="ui-icon-plus" cssClass="button" onclick="addBranchOffice();">Branch</sj:a>
	      			<%-- <%}%> --%>
				  </td>
			</tr>
		</tbody>
