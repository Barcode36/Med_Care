...
<script  src="js/jquery-ui.js"></script>
  ...
  //to get list of all department
    $.ajax({
    	    type : "post",
    	    url : "/over2cloud/view/Over2Cloud/MachineOrder/depatmentsforlist.action?deptFlag=dept",
...
function maptomultiplewing(emp){
	...
	$("#maximizeDataDiv1").html("<br><br><br><br><br><center><img src=images/lightbox-ico-loading.gif></center>");
	 $.ajax({
	    type : "post",
	    url : "/over2cloud/view/Over2Cloud/MachineOrderMaster/mappingMachine.jsp",
	    success : function(data) 
	    {
...
var delay = (function(){
	...
	$.ajax({
	      	    type : "post",
	      	    url : "/over2cloud/view/Over2Cloud/MachineOrder/BeforeConfigEscContact1.action?searchString="+search+"&deptId="+$("#department").val(),
	      	    success : function(data) {
    ...
    function democall(selval,editFlag){
  	//  alert(selval);
  	//alert($("#department option:selected").text());
  	 $("#shiftViewDiv").hide();
  	$("#dpetEmpDiv").show();
  	  $.ajax({
      	    type : "post",
      	    url : "/over2cloud/view/Over2Cloud/MachineOrder/BeforeConfigEscContact1.action?deptId="+selval,
      	    success : function(data) {
      	    	//alert(JSON.stringify(data));
      	    //	console.log(data);
                     	$('#catalog ul').empty();
   ...
   // #department option:selected").text()
    ...
    var dept=$("#department option:selected").text();
  	  $.ajax({
    	    type : "post",
    	    url : "/over2cloud/view/Over2Cloud/MachineOrder/getMachineDetail.action?deptId="+dept,
    	    success : function(data) {
    	    	$("#wings").empty();
  ...
  /*   //appending saved emp for floor
	...
	$("#shiftTO2").hide();
  	 shift_employeeIdsForSaveAs=[];
      	$.ajax({
      	type:"post",
      	url: "/over2cloud/view/Over2Cloud/MachineOrder/getmappedemployee.action?deptId="+$("#department").val()+"&shiftId="+shiftId+"&wingIds="+wing+"&viewFlag="+viewFlag,
      	async:false,
      	success: function(data){
      	//console.log(data);
 ...
 function adddivobj(divid){
	...
	$("#maxmizeViewDialog").dialog('open');
	 ...
	 $.ajax({
	  type : "post",
	   	    url : "/over2cloud/view/Over2Cloud/MachineOrder/deleteEmpByTrash.action",
	 ...
	 $.ajax({
	  type : "post",
	   	    url : "/over2cloud/view/Over2Cloud/MachineOrder/deleteEmpByTrash.action?viewFlag=ALL",
...
function refresh()
{
	 var deptId= $("#department").val();
 	  $.ajax({
   	    type : "post",
   	    url : "/over2cloud/view/Over2Cloud/MachineOrder/getMachineDetail.action",
   	    async:false,
   	    success : function(data) {
   	    	$("#wings").empty();
   	    	dynamiccount=data.length;
...
function fetchLiveShift(){
 ...
 function saveShift(){
	...
	$.ajax({
	  type : "post",
	    url : "/over2cloud/view/Over2Cloud/MachineOrder/addShiftWithWingMap.action",
...
function save(){
	...
	//alert(shift_employeemapped_wing);
	 $.ajax({
	  type : "post",
  	    url : "/over2cloud/view/Over2Cloud/MachineOrder/addShiftWithWingMapSave.action",
...
<div style="display: none;" id="trashMulDiv"></div>
	...
	<div id="shiftViewDiv" style="margin: 53px 21px 16px 21px;overflow: auto;height: 400px;"></div>
    	 	...
    	 	<td valign="top">
	            ...
	            <div class="draggable-demo-title jqx-rc-t" onclick="">Machine 
