...
function createMachineMaster()
{
	...
	$.ajax({
	    ...
	    url : "view/Over2Cloud/MachineOrder/beforemachineAdd.action",
...
function getOnChangeMachineData(searchFields)
{
	$.ajax({
	    ...
	    url : "view/Over2Cloud/MachineOrder/beforeMachineDataView.action?searchFields="+searchFields,
...
<div class="list-icon">
<div class="head">Machine</div><div class="head"><img alt="" src="images/forward.png" style="margin-top:50%; float: left;"></div><div class="head">View</div>
</div>
	...
	<table class="lvblayerTable secContentbb" border="0" cellpadding="0" cellspacing="0" width="100%">
		<tbody>
			...
			<s:select  
							    		id					=		"flag"
							    		name				=		"flag"
							    		list				=		"#{'Active':'Active','Inactive':'Inactive','Preventive Maintenace':'Preventive Maintenace','In Service':'In Service','Repaire':'Repaire','-1':'All'}"
							            cssClass            =      "button"
				  ...
				  <td class="alignright printTitle">
				    ...
				    <sj:a button="true" cssClass="button" cssStyle="height:25px;"  title="Add"  buttonIcon="ui-icon-plus" onclick="createMachineMaster();">Add</sj:a> 
