...
function setAutoCartEntry()
{

	$.ajax({
	    type : "post",
	    url : "view/Over2Cloud/MachineOrder/autoCartSet.action",
...
function getOnChangeMachineCartSetData(searchFields)
{
	$.ajax({
	    type : "post",
	    url : "view/Over2Cloud/MachineOrder/viewDataForCartset.action?searchFields="+searchFields,
...
getOnChangeMachineCartSetData('Active');
</script>
</head>
<body>
...
<div class="list-icon">
<div class="head">Machine Order Type</div><div class="head"><img alt="" src="images/forward.png" style="margin-top:50%; float: left;"></div><div class="head">View</div>
</div>
		...
		<tbody>
			...
			<s:select  
				  ...
				  <td class="alignright printTitle">
				    ...
				    <sj:a button="true" cssClass="button" cssStyle="height:25px;"  title="Add"  buttonIcon="ui-icon-plus" onclick="setAutoCartEntry();">Add</sj:a> 
