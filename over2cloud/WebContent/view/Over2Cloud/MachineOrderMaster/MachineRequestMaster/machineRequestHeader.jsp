...
<div class="list-icon">
 <div class="head">View Response Type </div><div class="head"><img alt="" src="images/forward.png" style="margin-top:50%; float: left;"></div><div class="head"><s:iterator value="totalCount">
		...
		<tbody>
			...
			<s:select  
				  ...
				  <td class="alignright printTitle">
				    ...
				    <sj:a button="true" cssClass="button" cssStyle="height:25px;"  title="Add"  buttonIcon="ui-icon-plus" onclick="createReasonMaster();">Add</sj:a> 
