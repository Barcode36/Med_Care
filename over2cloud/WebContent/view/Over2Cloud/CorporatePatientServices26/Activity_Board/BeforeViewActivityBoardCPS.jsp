...
<body>
	...
	<div style="border: blue; height: 67px;">
		...
		<%if(userRights.contains("echo_VIEW") || userTpe.equalsIgnoreCase("M")) 
							{%><!--commented by aarif
    ...
    -webkit-appearance: button; margin: 0px 5px 0px 0px;"
		...
		<!--chsnge_by_aarif_echo_to_hsme_due_to_HISview-->
			<a href="#" onclick="onloadDataCPS('', '', '', 'ECHO' ,'');"><img
				alt="" id="CARD" src="images/Echo2272015.png"
				style="margin-top: 0px; width: 69px; height: 59px; padding: 0px;appearance: button;
    -moz-appearance: button;
    -webkit-appearance: button; margin: 0px 5px 0px 0px;"
		...
		<%if(userRights.contains("xr_VIEW") || userTpe.equalsIgnoreCase("M")) 
							{%>
		<div style="float: right;">
			<a href="#" onclick="onloadDataCPS('', '', 'XR', '' ,'');"><img
    ...
    -webkit-appearance: button; margin: 0px 5px 0px 0px;"
		...
		<%if(userRights.contains("ultra_VIEW") || userTpe.equalsIgnoreCase("M")) 
							{%>
		<div style="float: right;">
			<a href="#" onclick="onloadDataCPS('', '', '', 'ULTRA' ,'');"><img
...
<%if(userRights.contains("ultra_VIEW") || userTpe.equalsIgnoreCase("M")) 
							{%>
		<div style="float: right;">
			<a href="#" onclick="onloadDataCPS('', '', '', 'CT' ,'');"><img
