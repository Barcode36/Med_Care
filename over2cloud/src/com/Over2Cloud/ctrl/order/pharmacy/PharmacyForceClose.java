package com.Over2Cloud.ctrl.order.pharmacy;
	...
	public class PharmacyForceClose implements Runnable {

		private static final Log log = LogFactory.getLog(PharmacyForceClose.class);
		...
		public PharmacyForceClose(SessionFactory connection, Session sessionHis ) {
		...
		public void run()
		{
					...
					try{
						while(true){
							...
							//CRCDATAFetchONE
							CDIH.forceClose(log, connection, sessionHis, ch);
		...
		public static void main(String[] args) {
			...
			try{
				...
				System.out.println("After HIS DB connection"+sessionHis);
					...
					Thread uclient=new Thread(new PharmacyForceClose(connection, sessionHis));
