...
public class InstantSMSSenderBPM implements Runnable{
	...
	public InstantSMSSenderBPM(final SessionFactory connection,final HelpdeskUniversalHelper HUHObj,final HelpdeskServiceFileHelper HF,final CommunicationHelper CHR)
	 {
	...
	public static void main(String args[])
		{
		  try{
				final SessionFactory connection = new ConnectionHelper().getSessionFactory("IN-5");
