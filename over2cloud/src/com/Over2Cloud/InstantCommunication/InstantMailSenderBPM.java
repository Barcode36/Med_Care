...
public class InstantMailSenderBPM implements Runnable
{
	String id = "";
	String emailid = "";
	String subject = "";
	...
	public InstantMailSenderBPM(SessionFactory connection)
	{
		    			...
		    			for (Iterator iterator = listMail.iterator(); iterator
							...
							if (update) {
								if (module!=null && !module.equals("") && !module.equals("NA") && emailid!=null &&!emailid.equals("") &&!emailid.equals("NA") && mailtext!=null &&!mailtext.equals("") &&!mailtext.equals("NA")) {
						    		...
						    		conditionclause.put("module_name", module);
	...
	public static void main(String args[])
		{
			try{
				 SessionFactory connection = new ConnectionHelper().getSessionFactory("IN-5");
				System.out.println("Connectiopn is as "+connection);
				while(true){
					Thread uclient=new Thread(new InstantMailSenderBPM(connection));
					uclient.start();
					uclient.join();
