...
public class DailyReportExcelWrite4Attach {
	...
	public String writeDataInExcel(List currentdayCounter,List CFCounter,List<FeedbackPojo> currentDayResolvedData,List<FeedbackPojo> currentDayPendingData,List<FeedbackPojo> currentDaySnoozeData,List<FeedbackPojo> currentDayHPData,List<FeedbackPojo> currentDayIgData,List<FeedbackPojo> currentDayReOpenData,List<FeedbackPojo> currentDayReAssignData,List<FeedbackPojo> currentDayAllReOpenData,List<FeedbackPojo> CFData, String deptLevel,String report_type)
	{
			...
			else if (currentDayAllReOpenData!=null && currentDayAllReOpenData.size()>0) {
				sheet.addMergedRegion(new CellRangeAddress(0, 0, 0,11));
			}
			else if (currentDayReAssignData!=null && currentDayReAssignData.size()>0) {
			...
			int index=4;
	 		...
	 		int header_5=header_4+(currentDayReOpenData.size())+3;
	 		int index5=header_5+1;
	 		int header_6=header_5+(currentDayReAssignData.size())+3;
	 		int index6=header_6+1;
	 		int header_7=header_6+(currentDayAllReOpenData.size())+3;
	 		int index7=header_7+1;
	 		...
	 		if (currentDayResolvedData.size()<=0) {
				 header_1=3;
	 			 ...
	 			 header_1=header_1+(currentDayResolvedData.size())+3;
		 		 index1=header_1+1;
			}
			...
			if (currentDayReOpenData.size()<=0) {
				 header_5=header_4;
		 		 index5=index4;
			}
			else {
				 header_5=header_4+(currentDayReOpenData.size())+3;
		 		 index5=header_5+1;
			}
			
			if (currentDayReAssignData.size()<=0) {
				 header_6=header_5;
		 		 index6=index5;
			}
			else {
				 header_6=header_5+(currentDayReAssignData.size())+3;
		 		 index6=header_6+1;
			}
			if (currentDayAllReOpenData.size()<=0) {
				 header_7=header_6;
		 		 index7=index6;
			}
			else {
				 header_7=header_6+(currentDayAllReOpenData.size())+3;
		 		 index7=header_7+1;
			}
			...
			rowHead.createCell((int) 1).setCellValue(" From Department ");
			...
			rowHead.createCell((int) 16).setCellValue(" Close Time ");
		 	rowHead.createCell((int) 17).setCellValue(" Action Taken ");
		 	rowHead.createCell((int) 18).setCellValue(" Action By ");
			
		 	rowHead.createCell((int) 19).setCellValue(" Location ");
		 	  ...
		 	  for (FeedbackPojo CDRD:currentDayResolvedData)
	 		   {
					...
					//Data Insertion as Ticket Lodged By Department Name
	 				...
	 				rowData.createCell((int) 1).setCellValue(CDRD.getFeedback_to_dept());
					...
					rowData.createCell((int) 6).setCellValue(CDRD.getFeedtype());
					...
					rowData.createCell((int) 14).setCellValue(CDRD.getHistoryStatus());
					rowData.createCell((int) 15).setCellValue(CDRD.getResolve_date());
					rowData.createCell((int) 16).setCellValue(CDRD.getResolve_time());
					 
					rowData.createCell((int) 17).setCellValue(CDRD.getResolve_remark());
					rowData.createCell((int) 18).setCellValue(CDRD.getResolve_by());
			...
			sheet.addMergedRegion(new CellRangeAddress(header_1-1, header_1-1, 0,21));
	 		...
	 		rowHead4.createCell((int) 1).setCellValue(" To Department ");
			...
			rowHead4.createCell((int) 20).setCellValue(" Snooze Reason ");
 			...
 			for (FeedbackPojo CDRD:currentDayPendingData) {
				...
				rowData.createCell((int) 7).setCellValue(CDRD.getEscalation_time());
			 	rowData.createCell((int) 8).setCellValue(CDRD.getHistoryStatus());
				
				rowData.createCell((int) 9).setCellValue(CDRD.getFeed_by());
				rowData.createCell((int) 10).setCellValue(CDRD.getFeedtype());
	 		...
	 		if(currentDaySnoozeData!=null && currentDaySnoozeData.size()>0)
			 {
				...
				sheet.addMergedRegion(new CellRangeAddress(header_2-1, header_2-1, 0,16));
				...
				rowHead1.createCell((int) 1).setCellValue(" To Department ");
				...
				rowHead1.createCell((int) 5).setCellValue(" Status ");
				...
				rowHead1.createCell((int) 16).setCellValue(" Location ");
	 			...
	 			for (FeedbackPojo CDRD:currentDaySnoozeData) {
					...
					rowData5.createCell((int) 1).setCellValue(CDRD.getFeedback_to_dept());
					...
					rowData5.createCell((int) 5).setCellValue(CDRD.getHistoryStatus());
					
					rowData5.createCell((int) 6).setCellValue(CDRD.getFeed_by());
					rowData5.createCell((int) 7).setCellValue(CDRD.getFeedtype());
					rowData5.createCell((int) 8).setCellValue(CDRD.getFeedback_subcatg());
	 		...
	 		if(currentDayHPData!=null && currentDayHPData.size()>0)
			  {
	 		  ...
	 		  // Code Start for showing the data for current day Snooze Tickets
				...
				rowHead2.createCell((int) 0).setCellValue(" From Department ");
				rowHead2.createCell((int) 1).setCellValue(" To Department ");
	 		...
	 		if(currentDayAllReOpenData!=null && currentDayAllReOpenData.size()>0)
			  {
				Row headerRow12 = sheet.createRow(header_6-1);
				headerRow12.setHeightInPoints(18);
				Cell headerTitleCell12 = headerRow12.createCell(0);
				headerTitleCell12.setCellValue("All Re-Opened Ticket Detail");
				headerTitleCell12.setCellStyle(styles.get("subTitle_HP"));
				sheet.addMergedRegion(new CellRangeAddress(header_6-1, header_6-1, 0,11));
	 		  // Code Start for showing the data for current day Snooze Tickets
		 		HSSFRow rowHead2 = sheet.createRow(header_6);
				rowHead2.createCell((int) 0).setCellValue(" From Department ");
				rowHead2.createCell((int) 1).setCellValue(" To Department ");
			...
			*/	rowHead2.createCell((int) 3).setCellValue(" Complaint Category ");
				rowHead2.createCell((int) 4).setCellValue(" Complaint Sub-Category ");
			
			 	rowHead2.createCell((int) 5).setCellValue(" Call Lodged By ");
				rowHead2.createCell((int) 6).setCellValue(" Re-Opened Reason ");
				rowHead2.createCell((int) 7).setCellValue(" Re-Opened Date ");
				rowHead2.createCell((int) 8).setCellValue(" Re-Opened Time ");
				rowHead2.createCell((int) 9).setCellValue(" Re-Opened By ");
			 	rowHead2.createCell((int) 10).setCellValue(" Alloted To ");
				rowHead2.createCell((int) 11).setCellValue(" Location ");
			
			
	 			for (FeedbackPojo CDRD:currentDayAllReOpenData)
	 			 {
	 				HSSFRow rowData=sheet.createRow((int)index3);
					//Data Insertion as Ticket Lodged By Department Name
					rowData.createCell((int) 0).setCellValue(CDRD.getFeedback_by_dept());
				...
				*/	
					rowData.createCell((int) 3).setCellValue(CDRD.getFeedtype());
					rowData.createCell((int) 4).setCellValue(CDRD.getFeedback_subcatg());
				
					rowData.createCell((int) 5).setCellValue(CDRD.getFeed_by());
					rowData.createCell((int) 6).setCellValue(CDRD.getReopen_reason());
					rowData.createCell((int) 7).setCellValue(CDRD.getReopen_date());
					rowData.createCell((int) 8).setCellValue(CDRD.getReopen_time());
					rowData.createCell((int) 9).setCellValue(CDRD.getFeed_registerby());
			 		rowData.createCell((int) 10).setCellValue(CDRD.getFeedback_allot_to());
					rowData.createCell((int)11).setCellValue(CDRD.getLocation());
					index3++;
	 				sheet.autoSizeColumn(index3);
				}
			  }
	 		...
	 		if(currentDayReAssignData!=null && currentDayReAssignData.size()>0)
			  {
				...
				headerRow12.setHeightInPoints(18);
				Cell headerTitleCell12 = headerRow12.createCell(0);
				headerTitleCell12.setCellValue("All Re-Assign Ticket Detail");
				headerTitleCell12.setCellStyle(styles.get("subTitle_HP"));
				sheet.addMergedRegion(new CellRangeAddress(header_5-1, header_5-1, 0,11));
	 		  // Code Start for showing the data for current day Snooze Tickets
		 		HSSFRow rowHead2 = sheet.createRow(header_6);
				rowHead2.createCell((int) 0).setCellValue(" From Department ");
				rowHead2.createCell((int) 1).setCellValue(" To Department ");
				...
				rowHead2.createCell((int) 4).setCellValue(" Open At ");
				rowHead2.createCell((int) 5).setCellValue(" Call Lodged By ");
				rowHead2.createCell((int) 6).setCellValue(" Re-Assign Reason ");
				rowHead2.createCell((int) 7).setCellValue(" Re-Assign Date ");
				rowHead2.createCell((int) 8).setCellValue(" Re-Assign Time ");
				rowHead2.createCell((int) 9).setCellValue(" Re-Assign By ");
			 	rowHead2.createCell((int) 10).setCellValue(" Alloted To ");
				rowHead2.createCell((int) 11).setCellValue(" Location ");
	 			...
	 			for (FeedbackPojo CDRD:currentDayAllReOpenData)
	 			 {
					...
					rowData.createCell((int) 4).setCellValue(CDRD.getOpen_time());
					rowData.createCell((int) 5).setCellValue(CDRD.getFeed_by());
					rowData.createCell((int) 6).setCellValue(CDRD.getReassign_reason());
					rowData.createCell((int) 7).setCellValue(CDRD.getReassign_date());
					rowData.createCell((int) 8).setCellValue(CDRD.getReassign_time());
					rowData.createCell((int) 9).setCellValue(CDRD.getFeed_registerby());
				 	rowData.createCell((int) 10).setCellValue(CDRD.getFeedback_allot_to());
					rowData.createCell((int) 11).setCellValue(CDRD.getLocation());
					index3++;
